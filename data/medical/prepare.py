...
if __name__=='__main__':
    ...
    train_ids.tofile(os.path.join(os.path.dirname(__file__), 'train2.bin'))
    val_ids.tofile(os.path.join(os.path.dirname(__file__), 'val2.bin'))

# train has 58,766,056 tokens
# val has 6,571,043 tokens
# train2 has 94,797,347 tokens
# val2 has 10,607,622 tokens